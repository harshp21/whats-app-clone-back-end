...
var authentication_sevice_1 = require("../../services/authentication-sevice");
// router config
...
router.get('/group-messages/:groupId', authentication_sevice_1.authenticate, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var group, messsageIds, messages, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, groups_1.Group.findOne({ _id: mongoose_1.default.Types.ObjectId(req.params.groupId) })];
            case 1:
                group = _a.sent();
                messsageIds = group.messageIds.map(function (messageId) { return mongoose_1.default.Types.ObjectId(messageId); });
...
router.post('/group', authentication_sevice_1.authenticate, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
