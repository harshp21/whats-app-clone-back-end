...
var group_route_1 = __importDefault(require("./router/group/group-route"));
...
app.use('/groups', group_route_1.default);
// db config
        ...
        socket.to(groupId).on('chat-message', function (msg) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        message = _a.sent();
                        return [4 /*yield*/, groups_1.Group.updateOne({ _id: mongoose_1.default.Types.ObjectId(groupId) }, { $push: { messageIds: message._id } })];
                    case 2:
                        _a.sent();
                        data = {
                            _id: message._id,
